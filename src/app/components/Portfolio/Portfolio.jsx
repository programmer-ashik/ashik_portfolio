              ...
              <div className=" group bg-black flex items-center justify-between p-4">
                <div>
                  <h4 className="text-lg font-semibold mb-2 text-gray-800 my-2">
                    <Link
                      href={item?.href}
                      className="relative text-white text-xl transition-colors duration-1000 hover:text-[#fb1359]
             ...
             after:transition-all after:duration-500 hover:after:w-full tracking-wide"
                ...
                <Link href={item.href} className="group relative inline-block">
                  <div className="w-14 h-14 border border-gray-700 bg-primary rounded-md flex items-center justify-center overflow-hidden transition-colors duration-500 group-hover:bg-red-500">
                    ...
                    <FaArrowRight className="absolute text-2xl text-white transform rotate-[-45deg] transition-all duration-500 group-hover:translate-x-6 group-hover:-translate-y-6 group-hover:opacity-0" />

                    {/* Second arrow: hidden by default, enters from bottom-left on hover */}
                    <GiAirplaneDeparture className="absolute text-3xl text-white transform rotate-[-45deg] translate-x-[-1.5rem] translate-y-[1.5rem] opacity-0 transition-all duration-500 group-hover:translate-x-0 group-hover:translate-y-0 group-hover:opacity-100" />
                  </div>
                </Link>
              </div>
            </motion.div>
